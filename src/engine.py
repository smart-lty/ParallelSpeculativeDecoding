...
class Decoding(ABC):
    def __init__(self, args):
        ...
        assert (self.accelerator.num_processes == 1 and args.eval_mode in ["small", "large", "sd"]) or (self.accelerator.num_processes == 2 and args.eval_mode.startswith("para_sd"))
    ...
    def load_model(self):
        ...
        elif self.args.eval_mode.startswith("para_sd"):
